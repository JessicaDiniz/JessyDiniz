...
#Clico em Comprar
  find('#compra').click
#Validação que Produto foi adicionado ao carrinho - Chamada por função 
  find(:xpath, "/html/body/div[1]/div/div[1]/div[3]/div[1]/div/div/button").execute_script("onclick").click
